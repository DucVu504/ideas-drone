...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-20 md:py-[120px] desktop:px-32">
      <div className="absolute left-0 top-0 -z-[1] h-full w-full dark:bg-dark"></div>
      <div
        className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-[#68b786] lg:h-[45%] xl:h-1/2"
        style={{
          backgroundImage: "url('/images/homepage/contact_bg.jpeg')",
      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="mt-56 flex flex-wrap justify-between lg:mb-0">
              <div className="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    383/11/4 Ba Hat Str, Ward 04, District 10, Ho Chi Minh City,
                    Vietnam
                  </p>
                </div>
              </div>
              ...
              <form>
                <div className="mb-[22px]">
                  ...
                  <input
                    type="text"
                    name="fullName"
                    placeholder={t('contact.fullname_plh')}
                ...
                <div className="mb-[22px]">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder={t('contact.email_plh')}
                    className="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none"
                  />
                </div>
                <div className="mb-[22px]">
