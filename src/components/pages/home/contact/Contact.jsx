...
const Contact = () => {
    return (
      <section id="contact" className="relative py-20 md:py-[120px]">
        ...
        <div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-[#68b786] lg:h-[45%] xl:h-1/2"
        style={{ backgroundImage: "url('/images/homepage/contact_bg.jpeg')",
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div className="ud-contact-content-wrapper">
                <div className="ud-contact-title px-8 py-4 mb-12 lg:mb-[150px]  bg-white rounded-xl opacity-50">
