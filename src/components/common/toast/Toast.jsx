...
const Toast = ({ type, message, duration = 4000 }) => {
    ...
    return (
      <div className="fixed top-0 left-1/2 transform -translate-x-1/2" aria-live="assertive"> 
        <div id={toast.id} className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow " role="alert">
          ...
          <button type="button" className="ml-auto bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8" aria-label="Close" onClick={() => setIsVisible(false)}> 
  ...
  Toast.propTypes = {
    ...
    duration: PropTypes.number,  // Optional prop for duration
  };
