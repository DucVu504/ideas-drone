                ...
                <div className="relative lg:container lg:mx-auto xl:px-20 px-4">
                    <div className="gap-16 lg:flex">
                        ...
                        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse pt-2">
                            <button type="button" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-6 py-2 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">TÌM HIỂU THÊM</button>
                        </div>
                        </div>
                    </div>
                </div>
